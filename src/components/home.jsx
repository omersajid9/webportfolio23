...
const Home = () =>
{
  ...
  useEffect(() => {
    ...
    return(
        <motion.div className="flex h-screen bg-inherit justify-center items-center overflow-hidden" ref={ref} initial="hidden" animate={controls} variants={boxVariants} transition={{ type: "spring", stiffness: 400, damping:50, duration: 0.8, delay: 0.3 }}>
