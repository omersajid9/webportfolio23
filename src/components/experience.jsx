...
const Experience = () =>
{
    ...
    const experienceA = ["Fermi National Accelerator Laboratory", "Quantum theory division intern", "August '22 - Present", "/public/fermilab_hd.png", a]
    ...
    const experienceA1 = ["Quantum Software Researcher", "Fermi National Accelerator Laboratory", "August '22 - Present", "public/fermilab_hd.png", a1]
    ...
    const experienceA2 = ["Summer Internship in Science & Technology", "Fermi National Accelerator Laboratory", "May '22 - August '22", "public/fermilab_hd.png", a2]
    ...
    const experienceA3 = ["Research Assistant: UCNtau Experiment", "DePauw University", "September '20 - August '21", "public/depauw.png", a3]
    ...
    const experienceA4 = ["Research Assistant: Crab Nebula", "DePauw University", "May '20 - August '20", "public/depauw.png", a4]
    ...
    const experienceA5 = ["Teacher Assistant, Modern Physics 1", "DePauw University", "January '20 - May '20", "public/depauw.png", a5]
    ...
    const experienceB2 = ["First Year Resident Assistant", "Housing & Residence Life", "July '21 - June '22", "public/depauw.png", b2]
    ...
    const experienceB3 = ["Teacher Assistant, Computer Science 120", "DePauw University", "January '21 - May '21", "public/depauw.png", b3]
    ...
    const experienceB4 = ["Information Technology Associate", "Tenzer Technology Center", "August 2020 - May 2021", "public/depauw.png", b4]
