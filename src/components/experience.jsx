    ...
    return (
        <div className="flex h-auto bg-inherit justify-center items-center">
             <div className=" bg-[#F2BAC9] bg-opacity-25 h-auto w-11/12 md:w-11/12 lg:w-8/12 rounded-2xl p-2 border-b-8 border-richBlack shadow-2xl drop-shadow-2xl">
                ...
                <div className="h-auto overflow-y-auto md:overflow-y-visible grid-flow-row grid-cols-2 grid justify-center md:space-x-0 gap-0 md:scrollbar-none scrollbar-thin scrollbar-thumb-yellow-800 md:py-2 py-2 px-2 md:px-2 ring-2 ring-[#F2BAC9] rounded-3xl shadow-inner shadow-black">
